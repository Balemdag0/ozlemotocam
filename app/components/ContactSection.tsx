            ...
            <div className="max-w-7xl mx-auto px-4 md:px-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <a
                                ...
                                className="flex items-center justify-center gap-3 bg-[#25d366] hover:bg-[#20b858] text-white font-bold text-base py-4 px-6 rounded-2xl transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-green-900/30 w-full"
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex items-center justify-center gap-3 bg-[#1e3a8a] text-white font-bold text-base py-4 px-6 rounded-2xl transition-all duration-300 hover:bg-[#1e40af] hover:-translate-y-0.5 hover:shadow-lg hover:shadow-blue-900/30 w-full"
                                style={{ fontFamily: 'Montserrat, sans-serif' }}
                            >
                    ...
                    <motion.div
                        ...
                        className="rounded-2xl overflow-hidden border border-[#2a2a2a] min-h-[350px] w-full h-full"
                    >
                        <iframe
