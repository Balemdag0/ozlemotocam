            ...
            <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <div className="text-center md:text-left">
                    <p className="text-[#9ca3af] text-sm mb-1" style={{ fontFamily: 'Inter, sans-serif' }}>
                        Sanayi Mahallesi, Şehit Ömer Yıldız Sokak No:43, Ortahisar / Trabzon
                    </p>
                ...
                <div className="flex items-center gap-4">
                    <a
                        href="https://www.instagram.com/ozlemotocamtrabzon"
                        target="_blank"
                    ...
                    <a
                        href="https://wa.me/905342502533"
                        target="_blank"
                        rel="noopener noreferrer"
                        aria-label="WhatsApp"
                        className="text-[#9ca3af] hover:text-[#25d366] transition-colors duration-200"
                    >
